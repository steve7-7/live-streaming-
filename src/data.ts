...
export const streams: Stream[] = [
  {
    id: "s1",
    title: "Late Night Lofi & Chill Beats 🎧",
    host: users[0],
    category: "Music",
    thumbnail: g("lofi"),
    viewers: 3421,
  ...
  {
    id: "s2",
    title: "Speedrunning Retro Classics",
    host: users[3],
    category: "Gaming",
    thumbnail: g("retro"),
    viewers: 8934,
  ...
  {
    id: "s3",
    title: "Cooking Ramen From Scratch 🍜",
    host: users[2],
    category: "Food",
    thumbnail: g("ramen"),
    viewers: 1205,
...
export const dmThreads: Record<string, DirectMessage[]> = {
  ...
  c4: [{ id: "d6", fromMe: false, text: "Sent you the invite link", time: "08:30" }],
  c3: [
    { id: "d7", fromMe: false, text: "Loved your last broadcast", time: "07:00" },
    { id: "d8", fromMe: true, text: "Thank you so much! 💜", time: "07:05" },
  ],
  c5: [{ id: "d9", fromMe: false, text: "Let's collab on a group call", time: "05:12" }],
};
...
export const feedPosts: FeedPost[] = [
  {
    id: "p1",
    user: users[0],
    caption: "Behind the scenes of tonight's set 🎶 who's tuning in?",
    media: g("bts1"),
    isVideo: false,
    likes: 2341,
    liked: false,
  ...
  },
  {
    id: "p2",
    user: users[3],
    caption: "New world record attempt today at 8pm. Come watch me suffer 😅",
    media: g("bts2"),
    isVideo: true,
    likes: 5678,
    liked: true,
